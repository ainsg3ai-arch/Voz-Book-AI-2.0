...
const Settings: React.FC = () => {
    ...
    return (
        <div className="relative flex flex-col w-full min-h-screen pb-20">
             <header className="sticky top-0 z-10 flex flex-col bg-[#0C1115]/90 backdrop-blur-xl px-6 md:px-10 pt-10 pb-6 border-b border-white/5">
            ...
            <main className="flex-1 px-6 md:px-10 space-y-10 mt-8 max-w-3xl mx-auto w-full">
                ...
                <section>
                    ...
                    <div className="flex flex-col overflow-hidden rounded-3xl glass-panel border border-white/5 bg-[#1a232d]/40">
                ...
                <div className="text-center py-8">
                    <p className="text-xs font-bold text-white/30 font-mono mb-1">VozBook AI v2.1.0</p>
